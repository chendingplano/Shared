...
func (t *MigrationTester) handleUp(ctx context.Context, migrator *sharedgoose.Migrator, result *autotester.TestResult) {
	err := migrator.Up(ctx)
	if err != nil {
	...
	result.Status = autotester.StatusPass
...
func (t *MigrationTester) handleUpByOne(ctx context.Context, migrator *sharedgoose.Migrator, result *autotester.TestResult) {
...
func (t *MigrationTester) handleUpTo(ctx context.Context, migrator *sharedgoose.Migrator, targetVersion int64, result *autotester.TestResult) {
...
func (t *MigrationTester) handleDown(ctx context.Context, migrator *sharedgoose.Migrator, result *autotester.TestResult) {
...
func (t *MigrationTester) handleDownTo(ctx context.Context, migrator *sharedgoose.Migrator, targetVersion int64, result *autotester.TestResult) {
...
func (t *MigrationTester) handleStatus(ctx context.Context, migrator *sharedgoose.Migrator, result *autotester.TestResult) {
...
func (t *MigrationTester) handleGetVersion(ctx context.Context, migrator *sharedgoose.Migrator, result *autotester.TestResult) {
...
func (t *MigrationTester) handleHasPending(ctx context.Context, migrator *sharedgoose.Migrator, result *autotester.TestResult) {
...
func (t *MigrationTester) handleListSources(migrator *sharedgoose.Migrator, result *autotester.TestResult) {
