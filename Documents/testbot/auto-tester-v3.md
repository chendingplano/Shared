# AutoTester: Automated Testing Framework (v3)
...
**Updated:** 2026/02/24 — Tester Packaging feature (v3)
...
func registerAll(cfg *config.Config) {
    ...
    // 2. Register shared packages
    sharedtesters.RegisterPackages()

    // 3. Register app-specific packages (may include shared testers)
